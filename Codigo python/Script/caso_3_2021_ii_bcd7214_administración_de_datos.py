...
class Analisis_Data():
  ...
  def total_percent_null(self, imprimir=True):
    cantidad_valores = (len(self.__datos.columns)*len(self.__datos))
    valores_perdidos = self.__datos.isnull().sum().sum()
    porcentaje = (valores_perdidos / cantidad_valores) * 100 

    if imprimir:
      print('Total datos: ' + str(cantidad_valores))
      print('Total valores perdidos: ' + str(analisis.datos.isnull().sum().sum()))
      print('Porcentaje total de valores perdidos: ' + str(porcentaje))
...
"""### Mostrando el porcentaje total de valores perdidos"""

analisis.total_percent_null(imprimir=True)
